...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        if (!resumeFile && !selfDescription.trim()) {
            alert("Please provide either a resume or a self-description before generating the report.")
            return
        }
        ...
        try {
            ...
            alert(error?.response?.data?.message || error.message || "Failed to generate interview report")
        }
    }
